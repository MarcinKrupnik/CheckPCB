...
def predict_pcb(self,choice):
    ...
    detected = model.predict(image_path.rstrip('.jpg')+'_resized'+'.jpg', confidence=30, overlap=15).json()
    # visualize your prediction
    model.predict(image_path.rstrip('.jpg')+'_resized'+'.jpg', confidence=30, overlap=15).save(image_path.rstrip('.jpg')+"_prediction.jpg")
