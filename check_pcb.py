...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.make_base_image.clicked.connect(lambda: make_image.make_image(self,str(self.ui.make_image_name),"base"))
        
        self.ui.make_prod_image.clicked.connect(lambda: make_image.make_image(self,str(self.ui.make_prod_combobox).currentText,self.ui.make_image_name))
